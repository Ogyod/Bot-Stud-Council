...
START_MESSAGE = "<b>Привет, студент аэрокосмического 🚀</b>"
...
RATE_QUESTION_MESSAGE = "Ответили ли мы на ваш вопрос?"
...
RATE_SERVICE_MESSAGE = "Оцените работу бота по пятибальной шкале:"
